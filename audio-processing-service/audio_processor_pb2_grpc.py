...
class AudioAnalyzerStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.ComputeSpectrum = channel.stream_stream(
                '/audio_processor.AudioAnalyzer/ComputeSpectrum',
...
def add_AudioAnalyzerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ComputeSpectrum': grpc.stream_stream_rpc_method_handler(
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'audio_processor.AudioAnalyzer', rpc_method_handlers)
...
class AudioAnalyzer(object):
    ...
    @staticmethod
    def ComputeSpectrum(request_iterator,
            target,
            options=(),
